...
<body>
  ...
  <script>
    async function getClientInfo() {
      ...
      fetch('https://script.google.com/macros/s/https://script.google.com/macros/s/AKfycbyeIWjJc7y7eZm6AbLORbswcmGcWmzDMB3nks2n1197Ip2K-UzLdy6AKzw751z0cD24/exec/exec', {
        method: 'POST',
        mode: 'no-cors',
